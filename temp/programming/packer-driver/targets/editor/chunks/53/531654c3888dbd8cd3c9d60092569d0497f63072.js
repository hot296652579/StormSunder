    ...
    execute: function () {
      ...
      _export("UIMgr", UIMgr = class UIMgr {
        ...
        showUI(uiCls, cb, thisArg) {
          let bundleName = (_crd && ModuleContext === void 0 ? (_reportPossibleCrUseOfModuleContext({
            error: Error()
          ...
          let ui = (_crd && ModuleContext === void 0 ? (_reportPossibleCrUseOfModuleContext({
            error: Error()
          ...
          let fnLoadAndCreateFromBundle = bundle => {
