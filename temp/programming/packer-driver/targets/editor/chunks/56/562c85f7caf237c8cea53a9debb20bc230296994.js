    ...
    execute: function () {
      ...
      _export("UIJoyStick", UIJoyStick = (_dec = ccclass('UIJoyStick'), _dec2 = property(Sprite), _dec3 = property(Sprite), _dec4 = property(CCFloat), _dec(_class = (_class2 = (_class3 = class UIJoyStick extends Component {
        ...
        onTouchStart(eventTouch) {
          ...
          let x = (_eventTouch$touch = eventTouch.touch) == null ? void 0 : _eventTouch$touch.getUILocationX();
          let y = (_eventTouch$touch2 = eventTouch.touch) == null ? void 0 : _eventTouch$touch2.getUILocationY();
        ...
        onTouchMove(touchEvent) {
          ...
          // 获取摇杆在 UI 的位置
          let x = (_touchEvent$touch = touchEvent.touch) == null ? void 0 : _touchEvent$touch.getUILocationX();
          let y = (_touchEvent$touch2 = touchEvent.touch) == null ? void 0 : _touchEvent$touch2.getUILocationY();
          let worldPosition = new Vec3(x, y, 0);
          let localPosition = v3(); // 转化摇杆的位置到背景图的本地坐标
