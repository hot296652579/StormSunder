  ...
  return {
    ...
    execute: function () {
      ...
      _export("UI_BattleResult_Impl", UI_BattleResult_Impl = class UI_BattleResult_Impl extends (_crd && UI_BattleResult === void 0 ? (_reportPossibleCrUseOfUI_BattleResult({
        ...
        initReward() {
          const userModel = (_crd && AttributeBonusMgr === void 0 ? (_reportPossibleCrUseOfAttributeBonusMgr({
            error: Error()
          ...
          const rewardRank = Number((userModel.game_reward_rank / 100).toFixed(2)); //最终奖励=[基础奖励×（1+属性提升值×属性养成加成）]×[1-(本局排名-1)×排名减益]
