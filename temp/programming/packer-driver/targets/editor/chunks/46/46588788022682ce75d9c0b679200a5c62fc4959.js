    ...
    execute: function () {
      ...
      _export("PropMoveComponent", PropMoveComponent = (_dec = ccclass('PropMoveComponent'), _dec2 = property({
        ...
        changeDirection() {
          ...
          const randomZ = randomRange(-1, 1); // 设置新的移动方向并归一化
        ...
        update(deltaTime) {
          ...
          const moveStep = this.moveSpeed * deltaTime; // 更新已移动距离

          this.distanceMoved += moveStep; // 计算移动向量

          const moveVec = new Vec3(this.currentDirection.x * moveStep, 0, this.currentDirection.z * moveStep); // 更新位置
