    ...
    execute: function () {
      ...
      _export("TimerMgr", TimerMgr = class TimerMgr {
        ...
        upateLbTime() {
          ...
          const lbTime = battleUI.getChildByPath('Times/LbTime'); // lbTime.getComponent(Label).string = this.countDownTime.toString();

          const format = (_crd && GameUtil === void 0 ? (_reportPossibleCrUseOfGameUtil({
            error: Error()
