    ...
    execute: function () {
      ...
      */
      _export("UserModel", UserModel = class UserModel {
        ...
        initialize() {
          var attackDevelopConfig = (_crd && AttributeBonusMgr === void 0 ? (_reportPossibleCrUseOfAttributeBonusMgr({
            error: Error()
          ...
          var speedDevelopConfig = (_crd && AttributeBonusMgr === void 0 ? (_reportPossibleCrUseOfAttributeBonusMgr({
            error: Error()
          }), AttributeBonusMgr) : AttributeBonusMgr).inst.developConfig.getConfigById((_crd && BonusType === void 0 ? (_reportPossibleCrUseOfBonusType({
            error: Error()
          }), BonusType) : BonusType).SPEED);
          var expDevelopConfig = (_crd && AttributeBonusMgr === void 0 ? (_reportPossibleCrUseOfAttributeBonusMgr({
            error: Error()
          }), AttributeBonusMgr) : AttributeBonusMgr).inst.developConfig.getConfigById((_crd && BonusType === void 0 ? (_reportPossibleCrUseOfBonusType({
            error: Error()
          }), BonusType) : BonusType).EXP);
          var mainConfig = (_crd && AttributeBonusMgr === void 0 ? (_reportPossibleCrUseOfAttributeBonusMgr({
            error: Error()
          ...
          var attack_base_currency = attackDevelopConfig.base_currency;
          var speed_base_currency = speedDevelopConfig.base_currency;
          var exp_base_currency = expDevelopConfig.base_currency; //属性初始值

          var attack_external_base = attackDevelopConfig.base;
          var speed_external_base = speedDevelopConfig.base;
          var exp_external_base = expDevelopConfig.base; //属性提升值

          var attack_external_upValue = attackDevelopConfig.up_value;
          var speed_external_upValue = speedDevelopConfig.up_value;
          var exp_external_upValue = expDevelopConfig.up_value;
          this.bonusData = {
