      ...
      _export("GameMgr", GameMgr = class GameMgr {
        ...
        updateGameStatusUI() {
          ...
          return _asyncToGenerator(function* () {
            var homeUI = (_crd && StormSunderGlobalInstance === void 0 ? (_reportPossibleCrUseOfStormSunderGlobalInstance({
              error: Error()
            ...
            switch (_this.gameStatus) {
              ...
              case GameStatus.Playing:
                yield (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
                  error: Error()
        ...
        startGame() {
          return _asyncToGenerator(function* () {
            ...
            yield (_crd && PropMgr === void 0 ? (_reportPossibleCrUseOfPropMgr({
              error: Error()
