  ...
  return {
    ...
    execute: function () {
      ...
      _export("RoosterStormSunder", RoosterStormSunder = (_dec = ccclass('RoosterStormSunder'), _dec(_class = class RoosterStormSunder extends Component {
        ...
        registerListener() {
          var btnRefresh = (_crd && StormSunderGlobalInstance === void 0 ? (_reportPossibleCrUseOfStormSunderGlobalInstance({
            error: Error()
          }), StormSunderGlobalInstance) : StormSunderGlobalInstance).instance.btnRefresh;
          var btnSet = (_crd && StormSunderGlobalInstance === void 0 ? (_reportPossibleCrUseOfStormSunderGlobalInstance({
            error: Error()
          }), StormSunderGlobalInstance) : StormSunderGlobalInstance).instance.btnSet;
          var btnStart = (_crd && StormSunderGlobalInstance === void 0 ? (_reportPossibleCrUseOfStormSunderGlobalInstance({
            error: Error()
        ...
        onClickSet() {
          ...
          var show = (_crd && tgxUIMgr === void 0 ? (_reportPossibleCrUseOftgxUIMgr({
            error: Error()
