System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("CharacterMovement", CharacterMovement = (_dec = ccclass('tgxCharacterMovement'), _dec2 = property(Camera), _dec3 = property(AnimationClip), _dec4 = property(AnimationClip), _dec5 = property(AnimationClip), _dec6 = property(AnimationClip), _dec7 = property(AnimationClip), _dec(_class = (_class2 = class CharacterMovement extends Component {
        constructor() {
          super(...arguments);
        ...
        start() {
          ...
          myCollider == null || myCollider.on('onCollisionEnter', target => {
...
//# sourceMappingURL=9b55530ea7148da10812a76f881e9288bc446b65.js.map