      ...
      _export("Start", Start = (_dec = ccclass('Start'), _dec2 = property(Label), _dec3 = property(Prefab), _dec4 = property(ProgressBar), _dec(_class = (_class2 = class Start extends Component {
        ...
        loadCustom() {
          return new Promise( /*#__PURE__*/_asyncToGenerator(function* (resolve, reject) {
            yield (_crd && JsonUtil === void 0 ? (_reportPossibleCrUseOfJsonUtil({
              error: Error()
        ...
        preloadRes(idx) {
          var res = _preloadRes[idx]; // console.log('预加载资源：' + res.url);
        ...
        onPreloadingComplete() {
          var bundle = assetManager.getBundle((_crd && ModuleDef === void 0 ? (_reportPossibleCrUseOfModuleDef({
            error: Error()
          }), ModuleDef) : ModuleDef).MODULE_STORM_SUNDER);
        ...
        update(deltaTime) {
          if (this._percent) {
            ...
            var idx = Math.floor(game.totalTime / 1000) % 3;
